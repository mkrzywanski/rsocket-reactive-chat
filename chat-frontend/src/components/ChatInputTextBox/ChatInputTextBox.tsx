  ...
  return (
    <div className="form-group basic-textarea">
      <InputGroup className="mb-3">
        <Form.Control size="lg" type="text" placeholder="Type your message here..." value={text} onChange={handleTextChange} as='textarea' rows={3} className={styles.textareaNoResize}/>
        <Button color="info"onClick={(event) => props.send(text)}>Send</Button>
      </InputGroup>
    </div>
  )
};
